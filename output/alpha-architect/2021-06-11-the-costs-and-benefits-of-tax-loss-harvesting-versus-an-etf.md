---
title: "The Costs and Benefits of Tax-Loss-Harvesting (TLH) Versus an ETF"
slug: "the-costs-and-benefits-of-tax-loss-harvesting-versus-an-etf"
date: "2021-06-11"
modified: "2022-05-23"
url: "https://alphaarchitect.com/the-costs-and-benefits-of-tax-loss-harvesting-versus-an-etf/"
categories: ["Research Insights", "Tax Efficient Investing", "ETF Investing"]
tags: []
best_of: false
...
Let’s first cover the primary potential tax cost/benefits of an ETF vehicle (a more detailed discussion is [available here](https://alphaarchitect.com/2014/04/01/why-etfs-are-more-tax-efficient-than-mutual-funds/)):

* **Benefit:** ETFs can leverage the custom create/redeem process to rebalance with very little, if any, immediate tax consequences for shareholders. Hence the reason most [ETFs have no capital gains distributions](https://www.morningstar.com/articles/1014538/etfs-again-proved-their-worth-to-taxable-investors-in-2020).
* **Benefit:** ETF fees are tax-deductible because ETFs distribute net income, which is income + dividends minus expenses and fees. In contrast, financial advisory fees are generally [not tax-deductible](https://www.kitces.com/blog/investment-advisory-fee-deduction-post-tcja-ira-expense-ratio-etf-limited-partnership/).
...
| Fee Deductibility | **Yes** | No |
| Loss passthrough | No | **Yes** |
| Customization | No | **Yes** |

This is a simple analysis and does not include every cost/benefit imaginable.
...
* NPV(short-term tax shields) = benefits of passing losses via an SMA.
  + ETFs cannot distribute losses ([although fin engineering](https://alphaarchitect.com/2014/12/15/an-affordable-tax-efficient-longshort-hedge-fund-solution/) can create something similar via an ETF and leverage in an SMA).
...
* NPV (trading costs) = the relative transaction costs tied to TLH programs versus ETF programs, taking into consideration impact costs, payment for order flow costs, and commissions (which are now ~0).
  ...
  + We recommend you read Maneesh’s [piece on this topic](https://alphaarchitect.com/2019/04/26/buyer-beware-the-reality-of-tax-loss-harvesting-benefits/) for more details.
...
| ↑1 | None of this is meant as tax advice and you should always consult your professional advisors to better understand the nuance and details of everything described below. |
 ...
 function footnote\_expand\_reference\_container\_61408\_155() { jQuery('#footnote\_references\_container\_61408\_155').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_61408\_155').text('−'); } function footnote\_collapse\_reference\_container\_61408\_155() { jQuery('#footnote\_references\_container\_61408\_155').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_61408\_155').text('+'); } function footnote\_expand\_collapse\_reference\_container\_61408\_155() { if (jQuery('#footnote\_references\_container\_61408\_155').is(':hidden')) { footnote\_expand\_reference\_container\_61408\_155(); } else { footnote\_collapse\_reference\_container\_61408\_155(); } } function footnote\_moveToReference\_61408\_155(p\_str\_TargetID) { footnote\_expand\_reference\_container\_61408\_155(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_61408\_155(p\_str\_TargetID) { footnote\_expand\_reference\_container\_61408\_155(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
