---
title: "ETF-prenuers: An Introduction to ETF White Label Services"
slug: "etf-prenuers-an-introduction-to-etf-white-label-services"
date: "2020-06-24"
modified: "2026-05-21"
url: "https://alphaarchitect.com/etf-prenuers-an-introduction-to-etf-white-label-services/"
categories: ["ETF Operations", "Best of Other", "Research Insights", "Key Research", "ETF Investing"]
tags: []
best_of: true
...
*Editor’s Note: [there is a podcast version](https://mebfaber.com/2020/10/23/episode-258-best-idea-show-wes-gray-alpha-architect-an-etf-centralizes-everything-into-one-product/) of this post, which is a nice follow-up to reading this article. Recently, we did a [follow-up podcast](https://mebfaber.com/2021/09/03/e347-radio-show/) with Pat Cleary. Audio/visual learners should check these out.*
...
![](https://alphaarchitect.com/wp-content/uploads/2020/06/2008-hedge-fund-idea-600x887.png)

Source: Unsplash and Alpha Architect art studio
...
Case in point: [Perth Tolle](https://www.lifeandlibertyindexes.com/).

![](https://alphaarchitect.com/wp-content/uploads/2022/01/Perth.jpg)
...
* Potential benefits
  ...
  + Tax efficiency (i.e., the [potential to defer capital gains](https://alphaarchitect.com/2014/04/01/why-etfs-are-more-tax-efficient-than-mutual-funds/) on equity, bond, and options instruments via in-kind transactions)
...
Arro Financial Communications has a great piece outlining the [various aspects of the ETF ecosystem](https://arrocomm.com/NTA) and how they all fit together. The graphic below is a snapshot and highlights the complexity involved.
...
![This is a diagram outlining the major players in the ETF ecosystem that ETF white label services are a part of.](https://alphaarchitect.com/wp-content/uploads/2020/09/etf-web.png)
...
We have tried to make the pricing on ETF white label as transparent as possible. In our own experience, the pricing typically involves some sort of fixed element, with a million footnotes highlighting random “nickel and dime” costs. Well, when you add up the nickels and dimes, they end up being material costs. So, our fixed costs estimate internalizes and underwrites everything into one simple figure (if you want a more detailed assessment, [reach out](#contact)).
...
* SEC fees ([24f-2 fees](https://www.sec.gov/news/press-release/2019-160))
* Printing fees
...
If you are interested in going the full “DIY route” or partial DIY, we can help point you in the right direction. [Reach out.](https://alphaarchitect.com/wp-admin/post.php?post=57547&action=edit#contact)
...
![](https://alphaarchitect.com/wp-content/uploads/2020/06/etf-architect-600x678.png)
...
|  |  |
| --- | --- |
| ↑1 | [Semper Fi, Do or Die, Hang ’em High on Eighth and I](https://en.wikipedia.org/wiki/Semper_fidelis)! |
...
| ↑7 | This risk is arguably limited since our friend Andrew Chanin and Nasdaq [were successful in their lawsuit](https://www.etf.com/sections/features-and-news/nasdaq-settles-etf-legal-fight-over-hack?nopaging=1) against the white-label provider |

 function footnote\_expand\_reference\_container\_57547\_71() { jQuery('#footnote\_references\_container\_57547\_71').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_57547\_71').text('−'); } function footnote\_collapse\_reference\_container\_57547\_71() { jQuery('#footnote\_references\_container\_57547\_71').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_57547\_71').text('+'); } function footnote\_expand\_collapse\_reference\_container\_57547\_71() { if (jQuery('#footnote\_references\_container\_57547\_71').is(':hidden')) { footnote\_expand\_reference\_container\_57547\_71(); } else { footnote\_collapse\_reference\_container\_57547\_71(); } } function footnote\_moveToReference\_57547\_71(p\_str\_TargetID) { footnote\_expand\_reference\_container\_57547\_71(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_57547\_71(p\_str\_TargetID) { footnote\_expand\_reference\_container\_57547\_71(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
