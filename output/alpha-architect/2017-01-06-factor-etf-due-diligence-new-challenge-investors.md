---
title: "Factor ETF Due Diligence: A New Challenge for Some Investors"
slug: "factor-etf-due-diligence-new-challenge-investors"
date: "2017-01-06"
modified: "2017-01-06"
url: "https://alphaarchitect.com/factor-etf-due-diligence-new-challenge-investors/"
categories: ["Factor Investing", "Basilico and Johnsen", "ETF Investing"]
tags: []
best_of: false
...
Factor investing seems to be everywhere, but the topic is still misunderstood by large swaths of the investing public. Tommi Johnsen and I would like to help bring clarity to the topic and help this blog [empower investors through education](http://alphaarchitdev.wpengine.com/2014/09/16/the-alpha-architect-value-proposition/). We also have a new book which will focus on ten of the more robust and evidence-based investing ideas presented via academic and practitioner research.(1)
...
We discuss a [recent article](http://www.edhec-risk.com/about_us/documents/attachments/IPE_EDHEC-Risk_Research_Insights_Autumn_2016.pdf) by Ducoulombier, Goltz and Ulahel(5) on the methodological differences across multi-factor index offerings. In particular, they review the robustness and consistency of the multi-factor indices and the level of diversification among the various options.
...
1. Selection bias, if there is a specific aim at selecting the best in sample factor performer;
2. [Overfitting bias](http://alphaarchitdev.wpengine.com/2016/06/28/backtesting-strategies-based-multiple-signals-beware-overfitting-biases/), when providers utilize composite scoring approaches (Novy-Marx, 2015)(8)

Table 3 shows some example of composite scores used in multi-factor indices.

**Table 1: Extract from Ducoulombier et al. (2016)**  
![table-1](https://alphaarchitect.com/wp-content/uploads/2016/12/Table-1.png)

**Table 2: Extract from Ducoulombier et al. (2016)**  
![table-2](https://alphaarchitect.com/wp-content/uploads/2016/12/Table-2.png)

**Table 3: Extract from Ducoulombier et al. (2016)**  
![table-3](https://alphaarchitect.com/wp-content/uploads/2016/12/Table-3.png)  
...
|  |  |
| --- | --- |
| ↑1 | You can also learn more at our website, at [academicinsightsoninvesting.com](http://academicinsightsoninvesting.com/)*,* wherewe strive to find the latest research to back investment ideas and to build robust investment portfolios. |
| ↑2 | 2016 Fact Book, Investment Company Institute |
| ↑3 | https://www.blackrock.com/corporate/en-us/newsroom/press-releases/article/corporate-one/press-releases/blackrock-smartbeta-research\_US |
...
| ↑9 | Lo, A.,W. (2016), What is an Index?, The Journal of Portfolio of Portfolio Management, Winter, n.42 |
 ...
 function footnote\_expand\_reference\_container\_25738\_169() { jQuery('#footnote\_references\_container\_25738\_169').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_25738\_169').text('−'); } function footnote\_collapse\_reference\_container\_25738\_169() { jQuery('#footnote\_references\_container\_25738\_169').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_25738\_169').text('+'); } function footnote\_expand\_collapse\_reference\_container\_25738\_169() { if (jQuery('#footnote\_references\_container\_25738\_169').is(':hidden')) { footnote\_expand\_reference\_container\_25738\_169(); } else { footnote\_collapse\_reference\_container\_25738\_169(); } } function footnote\_moveToReference\_25738\_169(p\_str\_TargetID) { footnote\_expand\_reference\_container\_25738\_169(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_25738\_169(p\_str\_TargetID) { footnote\_expand\_reference\_container\_25738\_169(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
