---
title: "How to Combine Value and Momentum Investing Strategies"
slug: "the-best-way-to-combine-value-and-momentum-investing-strategies"
date: "2015-03-26"
modified: "2026-05-21"
url: "https://alphaarchitect.com/the-best-way-to-combine-value-and-momentum-investing-strategies/"
categories: ["Best of Factor Investing", "Factor Investing", "Key Research", "Value Investing Research", "Momentum Investing Research"]
tags: []
best_of: true
...
We are probably most well known for our quantitative value investing strategies. The heart of our strategy is detailed in Wes’ book, [Quantitative Value](http://www.amazon.com/gp/product/1118328078/ref=as_li_tl?ie=UTF8&camp=1789&creative=390957&creativeASIN=1118328078&linkCode=as2&tag=welcomtothead-20&linkId=U7BGXMK6B4I7XCGQ) (a reader’s digest version is [here](https://alphaarchitect.com/2014/10/07/the-quantitative-value-investing-philosophy/#.VRP-GfzF9MU)). In the development of the Quantitative Value system there is no mention of the concept of “momentum investing,” which is a well-established empirical anomaly in the academic finance literature and a topic we cover extensively on the [blog](https://alphaarchitect.com/2014/07/16/momentum-investing-ride-winners-and-cut-losers-period/). And don’t get us wrong, even though we are value-investing fans, we are also huge fans of momentum investing. We have a book on that subject as well ([Quantitative Momentum](https://www.amazon.com/gp/offer-listing/111923719X/ref=tmm_hrd_new_olp_sr?ie=UTF8&condition=new&qid=&sr=&tag=alphaarchitec-20))
...
* [Part 1/2](#part1valmom)
* [Part 2/2](#part2valmom)
...
1. One solution is to combine the exposures as separate portfolios: part pure value; part pure momentum.
...
[![How to Combine Value and Momentum Investing Strategies_backtest 1](https://alphaarchitect.com/wp-content/uploads/2015/03/How-to-Combine-Value-and-Momentum-Investing-Strategies_backtest-1.png)](https://alphaarchitect.com/wp-content/uploads/2015/03/How-to-Combine-Value-and-Momentum-Investing-Strategies_backtest-1.png)
...
[![How to Combine Value and Momentum Investing Strategies_backtest 2](https://alphaarchitect.com/wp-content/uploads/2015/03/How-to-Combine-Value-and-Momentum-Investing-Strategies_backtest-2.png)](https://alphaarchitect.com/wp-content/uploads/2015/03/How-to-Combine-Value-and-Momentum-Investing-Strategies_backtest-2.png)
...
[![value investing portfolio results](https://alphaarchitect.com/wp-content/uploads/2015/04/value-investing-portfolio-results1.png)](https://alphaarchitect.com/wp-content/uploads/2015/04/value-investing-portfolio-results1.png)
...
[![momentum investing portfolio results](https://alphaarchitect.com/wp-content/uploads/2015/04/momentum-investing-portfolio-results.png)](https://alphaarchitect.com/wp-content/uploads/2015/04/momentum-investing-portfolio-results.png)
...
[![momentum and then value](https://alphaarchitect.com/wp-content/uploads/2015/04/momentum-and-then-value1.png)](https://alphaarchitect.com/wp-content/uploads/2015/04/momentum-and-then-value1.png)
...
[![value and then momentum](https://alphaarchitect.com/wp-content/uploads/2015/04/value-and-then-momentum.png)](https://alphaarchitect.com/wp-content/uploads/2015/04/value-and-then-momentum.png)
...
2. Results are similar to other [studies](http://papers.ssrn.com/sol3/papers.cfm?abstract_id=2329948).
...
So an obvious question is the following — ***Why don’t we integrate momentum in to our [Quantitative Value](https://alphaarchitect.com/2014/10/07/our-quantitative-value-philosophy/) strategy?***
...
As explained here, the Quantitative Value process [involves 5 steps](https://alphaarchitect.com/2014/10/07/our-quantitative-value-philosophy/). Step 4 requires us to sort firms based on their quality. However, what happens if we replace this step and sort firms by their past Momentum?
...
1. **QV EW** = Portfolio formed using the [Quantitative Value](https://alphaarchitect.com/2014/10/07/our-quantitative-value-philosophy/) process. Portfolio is equal-weighted and rebalanced annually.
2. **QV (High MOM) EW**= Portfolio formed using the first three steps of the [Quantitative Value](https://alphaarchitect.com/2014/10/07/our-quantitative-value-philosophy/) process. However, step 4 is changed to pick the top half of firms ranked on Momentum. Portfolio is equal-weighted and rebalanced annually.
3. **QV (Low MOM) EW**= Portfolio formed using the first three steps of the [Quantitative Value](https://alphaarchitect.com/2014/10/07/our-quantitative-value-philosophy/) process. However, step 4 is changed to pick the bottom half of firms ranked on Momentum. portfolio is equal-weighted and rebalanced annually.
4. **SP500** **EW** = S&P 500 equal-weight Total return
...
![Quantitative Value annual rebalance](https://alphaarchitect.com/wp-content/uploads/2015/04/Quantitative-Value-annual-rebalance.png)
...
1. **QV EW** **MR** = Portfolio formed using the [Quantitative Value](https://alphaarchitect.com/2014/10/07/our-quantitative-value-philosophy/) process. Portfolio is equal-weighted and rebalanced monthly.
2. **QV (High MOM) EW MR**= Portfolio formed using the first three steps of the [Quantitative Value](https://alphaarchitect.com/2014/10/07/our-quantitative-value-philosophy/) process. However, step 4 is changed to pick the top half of firms ranked on Momentum. Portfolio is equal-weighted and rebalanced monthly.
3. **QV (Low MOM) EW MR**= Portfolio formed using the first three steps of the [Quantitative Value](https://alphaarchitect.com/2014/10/07/our-quantitative-value-philosophy/) process. However, step 4 is changed to pick the bottom half of firms ranked on Momentum. portfolio is equal-weighted and rebalanced monthly.
4. **SP500** **EW** = S&P 500 equal-weight Total return
...
[![Quantitative Value monthly rebalance](https://alphaarchitect.com/wp-content/uploads/2015/04/Quantitative-Value-monthly-rebalance.png)](https://alphaarchitect.com/wp-content/uploads/2015/04/Quantitative-Value-monthly-rebalance.png)

The results are hypothetical results and are NOT an indicator of future results and do NOT represent returns that any investor actually attained. Indexes are unmanaged, do not reflect management or trading fees, and one cannot invest directly in an index. Additional information regarding the construction of these results is available upon request.

### **Takeaways:**

1. Rebalancing the Value portfolios monthly increases returns. This has been found in other [studies](https://www.aqr.com/library/data-sets/the-devil-in-hmls-details-factors-monthly). However, this should increase trading costs (which are not included here), and does increase drawdowns.
...
[![QV and Mom correlations](https://alphaarchitect.com/wp-content/uploads/2015/04/QV-and-Mom-correlations.png)](https://alphaarchitect.com/wp-content/uploads/2015/04/QV-and-Mom-correlations.png)
