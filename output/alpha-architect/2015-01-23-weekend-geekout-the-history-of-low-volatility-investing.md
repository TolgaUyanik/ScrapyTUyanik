---
title: "Weekend Geekout: The History of Low Volatility Investing"
slug: "weekend-geekout-the-history-of-low-volatility-investing"
date: "2015-01-23"
modified: "2022-05-30"
url: "https://alphaarchitect.com/weekend-geekout-the-history-of-low-volatility-investing/"
categories: ["Research Insights", "Investor Education", "Low Volatility Investing"]
tags: []
best_of: false
...
[Eric Falkenstein](http://falkenblog.blogspot.com/p/about-me.html) is an economist, with a PhD in economics, a quantitative geek, and a book writer.  In his blog, [Falkenblog](http://falkenblog.blogspot.com/), there are voluminous mind-blowing articles since 2008, which definitely worth your time to read. Recently he posted an article about the history of Low Volatility Investing and it’s a great educational piece we wanted to share with you. He authorizes us to re-post this article on our site (we have some small copy-edits). Enjoy!

### History of Low Volatility Investing

* Author: Eric Falkenstein

I saw [this story](http://www.businessweek.com/articles/2014-12-03/the-real-stock-market-risk-is-the-one-you-cant-see) in Bloomberg magazine a couple weeks ago, so I decided to speak with Ric Bratton again on the history of the low volatility effect. I wanted to speak more about other people’s work, especially Ed Miller and Bob Haugen, but somehow we missed that (it’s one take and he leads).  In any case, here it is.
...
A led to strange threads within the low volatility history such as [Harvey and Siddique’s 2000 paper](https://faculty.fuqua.duke.edu/~charvey/Research/Published_Papers/P56_Conditional_skewness_in.pdf) on skewness and returns. To the degree skewness relates to returns, it’s incidental to the low volatility anomaly. Yet back then you could not address it directly because it was too anomalous to standard theory–utility functions imply some kind of risk premium in an [iff](http://en.wikipedia.org/wiki/If_and_only_if) sense, they both imply the other.  So, they document that ‘co-skewness’ (which is positively correlated to volatility), is an extra preference by investors. This allows them to nest their finding within the standard paradigm, because understandibly people like the right tail of a distribution, not the left.

Yet, while they set up the model with the utmost rigor, they never paused to see if their results were  [consistent with global risk aversion](http://www.sciencedirect.com/science/article/pii/S037842660700297X). It’s not.  More practically, the counteracting effect in the Fama-French 3-factor world isn’t skew, it’s more basic, just volatility; no one makes ‘low skewness’ portfolios, though common low vol portfolios are correlated with that.
...
2. Risk begets return theory developed 1947-62 (CAPM)
   ...
   4. Empirically confirmed via the ‘equity premium’ estimate of 9.0% by [Lorie and Ficher](http://www.crsp.com/50/images/rates%20of%20return%20paper.pdf) (1964).
...
7. With hindsight, lots of early papers saw this
   1. [Richard McEnally](http://www.efalken.com/LowVolClassics/McEnally74.pdf) (1974) found high risk stock to have lower returns, and suggested the following reasons that are now considered highly relevant:
...
8. Why Important
   ...
   2. Science as a collective has biases just like individuals
      ...
      3. Focused on econometric issues (eg, [Shanken](http://www.efalken.com/LowVolClassics/Shanken1985.pdf), 1985, [Gibbons](http://www.efalken.com/LowVolClassics/Gibbon1982%20.pdf) 1982), not omitted variables like size
