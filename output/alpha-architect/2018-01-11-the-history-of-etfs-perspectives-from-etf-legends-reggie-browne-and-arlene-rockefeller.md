---
title: "The History of ETFs: Perspectives from ETF Legends, Reggie Browne and Arlene Rockefeller"
slug: "the-history-of-etfs-perspectives-from-etf-legends-reggie-browne-and-arlene-rockefeller"
date: "2018-01-11"
modified: "2022-05-13"
url: "https://alphaarchitect.com/the-history-of-etfs-perspectives-from-etf-legends-reggie-browne-and-arlene-rockefeller/"
categories: ["Interviews", "ETF Investing"]
tags: []
best_of: false
...
If perception is the reality, then the shift in concern from apocalyptic to “simply bad” is progress for us in ETF land. Outside commentary is trending in a positive direction. And with the marketplace’s better understanding of ETFs, has come a larger adoption of ETFs by financial advisors. The proof of this statement is evidence in a recently published [Cerulli report:](https://advisors.vanguard.com/iwe/pdf/FAETFPER.pdf?cbdForceDomain=true) advisor allocation to ETFs has gone from 7.8% of their portfolios in 2013, to 13.9% in 2017.

![](https://alphaarchitect.com/wp-content/uploads/2018/01/arlene-200x200.jpg)

Arlene Rockefeller

![](https://alphaarchitect.com/wp-content/uploads/2018/01/Reggie-Browne-Headshot-200x269.jpg)
...
>
> A third reason was [mutual funds would realize capital gains](https://alphaarchitect.com/2014/04/01/why-etfs-are-more-tax-efficient-than-mutual-funds/) that were not always aligned with the actual gains of the individual investors, and resulted in taxes before the investors sold their shares in the fund.
...
Many of these capabilities were not available to the average investor before the creation of ETFs. Like most tools, ETFs can be used for good or bad, but the democratization in investing they’ve provided is powerful. With [inflows of $464 billion in ETFs versus $9](https://www.marketwatch.com/story/etfs-shattered-their-growth-records-in-2017-2017-12-11)1 billion into mutual funds in 2017, it seems investors agree.
...
|  |  |
| --- | --- |
| ↑1 | ”[We think not.”](http://www.mainmgt.com/documents/SIG_ETF_Transactions_v3.pdf) |
| ↑2 | Eric Balchunas recently did a good job debunking that myth with his piece, [*It’s Not ETFs That Need Testing. It’s Investors*](https://www.bloomberg.com/view/articles/2017-11-08/it-s-not-etfs-that-need-testing-it-s-investors). |

 function footnote\_expand\_reference\_container\_34352\_3() { jQuery('#footnote\_references\_container\_34352\_3').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_34352\_3').text('−'); } function footnote\_collapse\_reference\_container\_34352\_3() { jQuery('#footnote\_references\_container\_34352\_3').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_34352\_3').text('+'); } function footnote\_expand\_collapse\_reference\_container\_34352\_3() { if (jQuery('#footnote\_references\_container\_34352\_3').is(':hidden')) { footnote\_expand\_reference\_container\_34352\_3(); } else { footnote\_collapse\_reference\_container\_34352\_3(); } } function footnote\_moveToReference\_34352\_3(p\_str\_TargetID) { footnote\_expand\_reference\_container\_34352\_3(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_34352\_3(p\_str\_TargetID) { footnote\_expand\_reference\_container\_34352\_3(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
