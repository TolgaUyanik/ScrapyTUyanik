---
title: "An Inside Look at How ETF Firms are Competing. Hint: Price Isn’t Everything"
slug: "an-inside-look-at-how-etf-firms-are-competing-hint-price-isnt-everything"
date: "2018-01-31"
modified: "2022-05-13"
url: "https://alphaarchitect.com/an-inside-look-at-how-etf-firms-are-competing-hint-price-isnt-everything/"
categories: ["Research Insights", "ETF Investing"]
tags: []
best_of: false
...
Morgan Housel had [a post on the idea of conflicting skill sets](http://www.collaborativefund.com/blog/conflicting-skill-sets/). Morgan makes the following comment:
...
![](https://alphaarchitect.com/wp-content/uploads/2017/12/rollerderby.jpg)
...
1. Be the low-cost leader
2. Provide great customer service
3. Provide great product (also known as providing value for your customer)
...
![](https://alphaarchitect.com/wp-content/uploads/2018/01/5-21-2012-AUM.png)

### The Present: Top 10 by AUM (11/28/17)

![](https://alphaarchitect.com/wp-content/uploads/2018/01/11-28-2017-by-AUM.png)
...
![](https://alphaarchitect.com/wp-content/uploads/2018/01/Top-10-by-Revenue.png)
...
![](https://alphaarchitect.com/wp-content/uploads/2018/01/full-year-2017-top-10-flows-e1517341943980.png)  
...
If SPY can’t win on liquidity and brand alone, and is sucked into the low-cost battle over a few bps, what’s to protect iShares MSCI EAFE ETF (EFA), the [fifth largest ETF](http://etfdb.com/compare/market-cap/) in the US at an expense ratio of 32 basis points?  Vanguard’s FTSE Developed Markets ETF (VEA) is close to EFA in AUM and charges only seven basis points for largely the same exposure. And Schwab’s International Equity ETF is putting additional pressure on the international developed market cap weighted category with their Schwab International Equity ETF ([SCHF](http://etfdb.com/etf/SCHF/)) at six(!) basis points and $14 billion in AUM. A year ago, I would’ve pointed to SPY as the example of how you can hold higher fees for similar exposures, but now that argument appears bunk.

OK. Liquidity and brand aren’t enough to stay ahead as the “great product” leader. Developing innovative new product types is another way to maintain your lead as the great product leader. iShares has done a good job on this front as well. For example, they have their suite of [factor ETFs](https://www.ishares.com/us/strategies/smart-beta). But with [Oppenheimer Funds, JP Morgan, John Hancock,](http://etfdb.com/news/2017/11/22/etf-launches-jp-morgan-oppenheimer-dive-into-factor-etfs/) launching their own factor tilted ETFs, and Vanguard launching their own [suite of factor ETFs](https://institutional.vanguard.com/VGApp/iip/site/institutional/researchcommentary/article/NewsInstInfo112817) (at what you know will be rock bottom prices), and Goldman Sachs has their own ultra [low-cost multifactor ETF](https://www.gsam.com/content/gsam/us/en/individual/products/etf-fund-finder/goldman-sachs-activebeta-u-s--large-cap-equity-etf.html#activeTab=performance) and…well you get the point. The price wars are on here too. If your factor product isn’t differentiated in some sustainable way that provides value to your clients, the long-term way to win is either service or low cost.

From a great service perspective, the battle is raging as well. One way firms are looking to provide their clients with great service is by providing them with the best financial tech available. At Alpha Architect, we offer our own suite of fintech tools to [assist advisors in building ETF portfolios](https://alphaarchitect.com/tools/). Wisdomtree is making a large push here through the acquisition of [Junxure](http://ir.wisdomtree.com/releasedetail.cfm?ReleaseID=1053010), through a fintech company they have a large holding in, AdvisorEngine. And iShares has their own [tools](https://www.ishares.com/us/resources/tools).  Like the list of ETF issuers offering factor tilted portfolios, the list of ETF issuers focusing on providing their clients better service through financial tech is growing.
...
Thank you to [Ken Ewell](https://www.grahamco.com/team/kenneth-ewell/) for helping with my thoughts on this piece, and to Tao Wang for assisting in gathering the data.
...
| ↑1 | It should be noted that, on average, investors are the biggest winners by being able to invest and pay a lower fee for more generic investments, such as market-cap weighted U.S. stock portfolios. |
 ...
 function footnote\_expand\_reference\_container\_34361\_179() { jQuery('#footnote\_references\_container\_34361\_179').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_34361\_179').text('−'); } function footnote\_collapse\_reference\_container\_34361\_179() { jQuery('#footnote\_references\_container\_34361\_179').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_34361\_179').text('+'); } function footnote\_expand\_collapse\_reference\_container\_34361\_179() { if (jQuery('#footnote\_references\_container\_34361\_179').is(':hidden')) { footnote\_expand\_reference\_container\_34361\_179(); } else { footnote\_collapse\_reference\_container\_34361\_179(); } } function footnote\_moveToReference\_34361\_179(p\_str\_TargetID) { footnote\_expand\_reference\_container\_34361\_179(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_34361\_179(p\_str\_TargetID) { footnote\_expand\_reference\_container\_34361\_179(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
