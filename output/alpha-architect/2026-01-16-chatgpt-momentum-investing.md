...
slug: "chatgpt-momentum-investing"
date: "2026-01-16"
modified: "2026-01-12"
url: "https://alphaarchitect.com/chatgpt-momentum-investing/"
...
![](https://alphaarchitect.com/wp-content/uploads/2025/12/out-of-sample-1200x401.png)
...
The researchers used ChatGPT 4.0 mini, a relatively inexpensive model. They didn’t fine-tune it or require massive computational resources. This means individual investors or smaller asset managers could potentially implement similar approaches without prohibitive infrastructure costs. However, one note of caution is that the use of a one-day look back at the news strategy might have a flaw in that news on stocks is often conveyed *after the close*. In that case, the news is reflected in the *opening price* the next morning. Typically, momentum (and other monthly) strategies use closing prices. Thus, the advantage conveyed by a one-day lookback may not be realizable in real life.
