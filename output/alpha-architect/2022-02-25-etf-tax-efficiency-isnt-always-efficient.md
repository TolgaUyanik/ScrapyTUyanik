---
title: "ETF Tax Efficiency isn’t Always Efficient"
slug: "etf-tax-efficiency-isnt-always-efficient"
date: "2022-02-25"
modified: "2022-09-30"
url: "https://alphaarchitect.com/etf-tax-efficiency-isnt-always-efficient/"
categories: ["Research Insights", "Guest Posts", "Tax Efficient Investing", "ETF Investing"]
tags: []
best_of: false
...
**WHEREAS**, Wes Gray hires you to join the team at [ETF Architect](https://etfarchitect.com/); and
...
Drawing the short straw, Wes asked that I put together a piece that throws some cold water on [ETF tax efficiency.](https://alphaarchitect.com/2014/04/01/why-etfs-are-more-tax-efficient-than-mutual-funds/) Why? Well, there are already plenty of situations where ETFs are [incredibly tax-efficient](https://alphaarchitect.com/2014/04/01/why-etfs-are-more-tax-efficient-than-mutual-funds/), but we want to provide a fuller picture.(1).
...
These topics aren’t fun (even for CPA nerds like me), but are an important facet of [ETF servicing](https://alphaarchitect.com/2021/11/16/how-to-start-an-etf-resources-and-faq/) and for buyers of ETFs. The more knowledge a fund sponsor has of potential pitfalls, the easier they are to proactively address. The goal is to thread the needle of tax efficiency while still maintaining integrity to the fund’s strategy. Refreshed by the cold water wash, let us help choreograph the dance that is ETF operations.
...
| ↑2 | Wes does a good job explaining “in-kind” transactions towards the end of this [Post](https://alphaarchitect.com/2014/04/01/why-etfs-are-more-tax-efficient-than-mutual-funds/). |

 function footnote\_expand\_reference\_container\_69569\_79() { jQuery('#footnote\_references\_container\_69569\_79').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_69569\_79').text('−'); } function footnote\_collapse\_reference\_container\_69569\_79() { jQuery('#footnote\_references\_container\_69569\_79').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_69569\_79').text('+'); } function footnote\_expand\_collapse\_reference\_container\_69569\_79() { if (jQuery('#footnote\_references\_container\_69569\_79').is(':hidden')) { footnote\_expand\_reference\_container\_69569\_79(); } else { footnote\_collapse\_reference\_container\_69569\_79(); } } function footnote\_moveToReference\_69569\_79(p\_str\_TargetID) { footnote\_expand\_reference\_container\_69569\_79(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_69569\_79(p\_str\_TargetID) { footnote\_expand\_reference\_container\_69569\_79(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
