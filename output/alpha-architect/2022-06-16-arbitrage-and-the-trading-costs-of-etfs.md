---
title: "Arbitrage and the Trading Costs of ETFs"
slug: "arbitrage-and-the-trading-costs-of-etfs"
date: "2022-06-16"
modified: "2022-06-16"
url: "https://alphaarchitect.com/arbitrage-and-the-trading-costs-of-etfs/"
categories: ["Transaction Costs", "Research Insights", "Larry Swedroe", "Academic Research Insight", "ETF Investing"]
tags: []
best_of: false
...
Alpha Architect lives by the mission of “empowering investors through education.” Alpha Architect also operates ETF Architect, which is a low-cost [white-label ETF](https://alphaarchitect.com/2021/11/how-to-start-an-etf-resources-and-faq/) business. Their team lives ETF operations every day and they were helpful in helping me craft this post. (For a deep dive into ETF trading, please take the time to read Wes’ post on [ETFs in the secondary market](https://alphaarchitect.com/2014/12/trading-etfs-in-the-secondary-market/).)
...
4. Costly exchange conditions limit arbitrage activity, while the magnitude of mispricing apparently affects the decision to arbitrage, but not the size of the arbitrage trade.
...
5. ETFs with larger bid-ask spreads are less likely to have either a creation or redemption, suggesting that higher costs of trading limit arbitrage.
...
Fulkerson, Jordan and Travis’ findings are consistent with those of Antti Petajisto, author of the study “[Inefficiencies in the Pricing of Exchange-Traded Funds](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2000336),” published in the first quarter 2017 issue of the Financial Analysts Journal. He found that while the average premium was only 6 basis points (bps), the time-series volatility of the premium was 49 bps—ETF prices fluctuate considerably around NAVs even if the average level is correct. The value-weighted average volatility was comparable at 40 bps—the result was not limited to smaller funds.
...
| ↑3 | See TAIL’s [website](https://www.cambriafunds.com/tail-premium-discount) as an example |
| ↑4 | Just only make the brokers aware of a creation unit size trade, not which side of the trade you’re going to be on when asking for a bid/ask |
 ...
 function footnote\_expand\_reference\_container\_80348\_26() { jQuery('#footnote\_references\_container\_80348\_26').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_80348\_26').text('−'); } function footnote\_collapse\_reference\_container\_80348\_26() { jQuery('#footnote\_references\_container\_80348\_26').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_80348\_26').text('+'); } function footnote\_expand\_collapse\_reference\_container\_80348\_26() { if (jQuery('#footnote\_references\_container\_80348\_26').is(':hidden')) { footnote\_expand\_reference\_container\_80348\_26(); } else { footnote\_collapse\_reference\_container\_80348\_26(); } } function footnote\_moveToReference\_80348\_26(p\_str\_TargetID) { footnote\_expand\_reference\_container\_80348\_26(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_80348\_26(p\_str\_TargetID) { footnote\_expand\_reference\_container\_80348\_26(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
