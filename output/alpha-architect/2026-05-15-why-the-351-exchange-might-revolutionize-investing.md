...
slug: "why-the-351-exchange-might-revolutionize-investing"
date: "2026-05-15"
modified: "2026-05-21"
...
tags: ["351 exchange", "Brent Sullivan"]
best_of: true
...
![](https://alphaarchitect.com/wp-content/uploads/2026/05/Screenshot-2026-05-04-095004.png)

Sullivan, Brent and Rozner, Elliot, Managing Concentrated Public Stock Positions by Seeding an Exchange-Traded Fund (March 31, 2026).
...
I invited Brent Sullivan, Chief Editor at [Tax Alpha Insider](https://www.taxalphainsider.com/), over to our YouTube channel to help unpack the modern-day applications of the 351 tax rules. If you want to watch our video, I encourage you to [subscribe to our channel](https://www.youtube.com/@alphaarchitect?sub_confirmation=1). But in this post, I’ll walk through my three main takeaways from our discussion, along with some warnings for investors considering seeding ETFs via a 351 exchange (and what tends to get them into trouble).
...
1. Sullivan, Brent and Rozner, Elliot, Managing Concentrated Public Stock Positions by Seeding an Exchange-Traded Fund (March 31, 2026). pp 7. [↩︎](#edf5b787-b2be-474e-891e-53463f971fa4-link)
2. Brent’s words, not mine. [↩︎](#22e839e1-fb95-4697-82ba-505dc7c973dd-link)
3. After all, we exist to empower investors through education! [↩︎](#b8317013-50fe-4e7a-a410-85a2f8de30d5-link)
...
|  |  |
| --- | --- |
| ↑1 | the laws were setup for partnerships to deal with that via sec. 721 |

 function footnote\_expand\_reference\_container\_97108\_21() { jQuery('#footnote\_references\_container\_97108\_21').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_97108\_21').text('−'); } function footnote\_collapse\_reference\_container\_97108\_21() { jQuery('#footnote\_references\_container\_97108\_21').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_97108\_21').text('+'); } function footnote\_expand\_collapse\_reference\_container\_97108\_21() { if (jQuery('#footnote\_references\_container\_97108\_21').is(':hidden')) { footnote\_expand\_reference\_container\_97108\_21(); } else { footnote\_collapse\_reference\_container\_97108\_21(); } } function footnote\_moveToReference\_97108\_21(p\_str\_TargetID) { footnote\_expand\_reference\_container\_97108\_21(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_97108\_21(p\_str\_TargetID) { footnote\_expand\_reference\_container\_97108\_21(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
