---
title: "Smart Beta is Officially Dead, but Not Forgotten"
slug: "what-is-smart-beta"
date: "2018-09-06"
modified: "2022-05-17"
url: "https://alphaarchitect.com/what-is-smart-beta/"
...
Here’s his original definition (from a [great piece](https://www.researchaffiliates.com/en_us/publications/articles/292_what_smart_beta_means_to_us.html) attempting to bring sanity to the debate in 2014):
...
And recently on Barry Ritholtz’s podcast, [Masters in Business](http://ritholtz.com/2018/07/transcript-research-affiliates-rob-arnott/), Rob and Barry had this exchange (emphasis my own);
...
From Eric Balchunas [@EricBalchunas](https://twitter.com/EricBalchunas):

> Smart-beta is active management served in better packaging.

From Phil Huber [@bpsandpieces](https://twitter.com/bpsandpieces):
...
From Justin Castelli [@jus10castelli](https://twitter.com/jus10castelli):
...
From Lawrence Hamtil [@LHamtil](https://twitter.com/lhamtil):
...
From Ben Johnson [@MstarETFUS](https://twitter.com/MstarETFUS) (who even gave us a chart to bring clarity through visuals):
...
![](https://alphaarchitect.com/wp-content/uploads/2018/09/llll.png)  
And there’s the comical definition from [@ROIChristie](https://twitter.com/ROIChristie):

> We call it smart beta, but I petitioned hard to try to frame it to clients as dumb alpha…

I also spoke with Corey Hoffstein [@choffstein](https://twitter.com/choffstein). Corey holds a Master of Science in Computational Finance from Carnegie Mellon University and a Bachelor of Science in Computer Science, cum laude, from Cornell University. He’s about as qualified to answer a financial question as anyone out there…

Here’s his answer when I asked him “What is smart beta?”:

![](https://alphaarchitect.com/wp-content/uploads/2018/08/hoffstein-smart-beta-600x302.png)
...
![](https://alphaarchitect.com/wp-content/uploads/2018/08/Smart-Beta-Originals-mkt-share-600x339.png)
...
![](https://alphaarchitect.com/wp-content/uploads/2018/08/RIP-Smart-Beta-800x533.jpg)
...
|  |  |
| --- | --- |
| ↑1 | (that’s where it [all goes down](https://www.youtube.com/watch?v=YXSpXO4N-tI) after all) |
| ↑2 | If you are still confused on what “active investing” is, [here is a piece](https://alphaarchitect.com/2017/02/24/active-versus-passive-investing-can-we-end-the-confusion/) to end that confusion. |
...
| ↑4 | did I force this reference in there? Maybe. But I was scared this would be my best shot at ever jamming this scene into a blog, and I love this scene, so here you go people. |
 ...
 function footnote\_expand\_reference\_container\_40736\_159() { jQuery('#footnote\_references\_container\_40736\_159').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_40736\_159').text('−'); } function footnote\_collapse\_reference\_container\_40736\_159() { jQuery('#footnote\_references\_container\_40736\_159').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_40736\_159').text('+'); } function footnote\_expand\_collapse\_reference\_container\_40736\_159() { if (jQuery('#footnote\_references\_container\_40736\_159').is(':hidden')) { footnote\_expand\_reference\_container\_40736\_159(); } else { footnote\_collapse\_reference\_container\_40736\_159(); } } function footnote\_moveToReference\_40736\_159(p\_str\_TargetID) { footnote\_expand\_reference\_container\_40736\_159(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_40736\_159(p\_str\_TargetID) { footnote\_expand\_reference\_container\_40736\_159(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
