---
title: "​Can you convert a mutual fund into an ETF tax efficiently (or an SMA or hedge fund)?"
slug: "can-you-convert-a-mutual-fund-into-an-etf-tax-efficiently-or-an-sma-or-hedge-fund"
date: "2021-05-28"
modified: "2023-01-16"
url: "https://alphaarchitect.com/can-you-convert-a-mutual-fund-into-an-etf-tax-efficiently-or-an-sma-or-hedge-fund/"
categories: ["ETF Operations", "Research Insights", "ETF Investing"]
tags: []
best_of: false
...
> The question we keep getting, in various forms, is the following: Can you do a tax-free conversion of a mutual fund into an ETF? Can you do a tax-free conversion of SMAs (separately managed accounts) into an ETF? Can you do a tax-free conversion of a hedge fund into an ETF? Long story short, yes, yes, and yes…but it’s complicated!
...
Note: this post was co-written with [Sean Hegarty, CPA](https://etfarchitect.com/executive-team/)
...
* [See section 851](https://www.law.cornell.edu/uscode/text/26/851) for more details.
...
* Note: Stradley Ronon and Morgan Lewis have a nice explainer piece on 351 [here](https://www.morganlewis.com/events/~/media/1d6490355b3c479a8f8769be0d3df9c0.ashx).
...
| ↑2 | Please note that this is merely an illustrative example. Each situation is different and will require specific legal/tax guidance from professionals. |
 ...
 function footnote\_expand\_reference\_container\_63322\_171() { jQuery('#footnote\_references\_container\_63322\_171').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_63322\_171').text('−'); } function footnote\_collapse\_reference\_container\_63322\_171() { jQuery('#footnote\_references\_container\_63322\_171').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_63322\_171').text('+'); } function footnote\_expand\_collapse\_reference\_container\_63322\_171() { if (jQuery('#footnote\_references\_container\_63322\_171').is(':hidden')) { footnote\_expand\_reference\_container\_63322\_171(); } else { footnote\_collapse\_reference\_container\_63322\_171(); } } function footnote\_moveToReference\_63322\_171(p\_str\_TargetID) { footnote\_expand\_reference\_container\_63322\_171(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_63322\_171(p\_str\_TargetID) { footnote\_expand\_reference\_container\_63322\_171(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
