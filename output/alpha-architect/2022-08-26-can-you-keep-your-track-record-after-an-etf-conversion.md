---
title: "Can You Keep Your Track Record After an ETF Conversion?"
slug: "can-you-keep-your-track-record-after-an-etf-conversion"
date: "2022-08-26"
modified: "2022-10-17"
url: "https://alphaarchitect.com/can-you-keep-your-track-record-after-an-etf-conversion/"
...
We get a lot of questions related to whether or not you can keep your official track record when you do a [tax-free ETF conversion](https://alphaarchitect.com/2021/05/can-you-convert-a-mutual-fund-into-an-etf-tax-efficiently-or-an-sma-or-hedge-fund/). The short answer is yes, you can keep your official track record, but it can be complicated.
...
* Hedge fund conversions
  + More complex, but possible. The primary requirement is the the old track record’s calculation standards meet 40-Act requirements. [Here is a no action](https://www.sec.gov/divisions/investment/noaction/1995/massmutualinstitutional092895.pdf) letter that walks through the details.(1)
...
Hit up our [ETF Architect](https://etfarchitect.com/) website and/or reach out if you have any more questions:
...
| ↑2 | If the tracks are not in the main table, it will be tough to get FINRA approval for standard marketing approval. This also means you really need a multi-year track record to ensure you fit the standardized, full calendar year track record (e.g., 9 months in 2018 and 9 months in 2019 is no good. Best to have FULL CALENDAR year tracks to minimize issues). |
 ...
 function footnote\_expand\_reference\_container\_82017\_91() { jQuery('#footnote\_references\_container\_82017\_91').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_82017\_91').text('−'); } function footnote\_collapse\_reference\_container\_82017\_91() { jQuery('#footnote\_references\_container\_82017\_91').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_82017\_91').text('+'); } function footnote\_expand\_collapse\_reference\_container\_82017\_91() { if (jQuery('#footnote\_references\_container\_82017\_91').is(':hidden')) { footnote\_expand\_reference\_container\_82017\_91(); } else { footnote\_collapse\_reference\_container\_82017\_91(); } } function footnote\_moveToReference\_82017\_91(p\_str\_TargetID) { footnote\_expand\_reference\_container\_82017\_91(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_82017\_91(p\_str\_TargetID) { footnote\_expand\_reference\_container\_82017\_91(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
