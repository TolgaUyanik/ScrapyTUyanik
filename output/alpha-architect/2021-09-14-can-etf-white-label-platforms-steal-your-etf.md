---
title: "Can ETF white label platforms “steal” your ETF?"
slug: "can-etf-white-label-platforms-steal-your-etf"
date: "2021-09-14"
modified: "2022-06-24"
url: "https://alphaarchitect.com/can-etf-white-label-platforms-steal-your-etf/"
categories: ["ETF Operations", "ETF Investing"]
tags: []
best_of: false
...
> As readers know, our firm’s mission is to empower investors through education. We live that mission every day. In this piece, we walk through the […]
...
Turns out that our “investment business” mission applies to [ETF Architect](https://etfarchitect.com/). ETF Architect is the trade name for our fast-growing ETF white-label business, which seeks to deliver high-quality, affordable, one-stop-shop access to the ETF market.
...
The infamous HACK scenario involved a white-label platform (ETF Managers Group, “ETFMG”). ETFMG was being sued for [“stealing” an ETF](https://www.wsj.com/articles/an-alleged-theft-of-a-billion-dollar-fund-grips-etf-world-1515666601) by Nasdaq (and Andrew Chanin at PureShares). ETFMG believed Nasdaq/PureShares were in material breach of their obligations to HACK. Nasdaq/PureShares felt like ETFMG was simply trying to steal their hard-earned profits from building the fund in the first place. [Turns out a judge agreed](https://www.wsj.com/articles/nasdaq-prevails-in-lawsuit-over-alleged-etf-theft-11576884078) with Nasdaq/PureShares and ordered ETFMG to pay $78mm+. Yikes! ([see here](https://www.nysd.uscourts.gov/sites/default/files/2019-12/17-cv-8252.pdf) for the gory details). Kids, this legal memo is what we call in the biz “getting taken to the woodshed.”
...
This goes without saying, but integrity is everything in business and in life — this is especially true for those of us who have [been in the Service](https://alphaarchitect.com/2015/05/25/from-the-frontlines-to-finance-how-the-marines-shaped-our-investment-philosophy/). If you don’t have integrity, you really don’t have anything.
...
| ↑1 | Disclaimer: the items below are not meant to be full-blown legal advice (that’s why lawyers make the big bucks). The bullets below are simply meant to provide a basic framework and understanding of how things are typically structured. |
 ...
 function footnote\_expand\_reference\_container\_66992\_75() { jQuery('#footnote\_references\_container\_66992\_75').show(); jQuery('#footnote\_reference\_container\_collapse\_button\_66992\_75').text('−'); } function footnote\_collapse\_reference\_container\_66992\_75() { jQuery('#footnote\_references\_container\_66992\_75').hide(); jQuery('#footnote\_reference\_container\_collapse\_button\_66992\_75').text('+'); } function footnote\_expand\_collapse\_reference\_container\_66992\_75() { if (jQuery('#footnote\_references\_container\_66992\_75').is(':hidden')) { footnote\_expand\_reference\_container\_66992\_75(); } else { footnote\_collapse\_reference\_container\_66992\_75(); } } function footnote\_moveToReference\_66992\_75(p\_str\_TargetID) { footnote\_expand\_reference\_container\_66992\_75(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } } function footnote\_moveToAnchor\_66992\_75(p\_str\_TargetID) { footnote\_expand\_reference\_container\_66992\_75(); var l\_obj\_Target = jQuery('#' + p\_str\_TargetID); if (l\_obj\_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l\_obj\_Target.offset().top - window.innerHeight \* 0.2 }, 380); } }
